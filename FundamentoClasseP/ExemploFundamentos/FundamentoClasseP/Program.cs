//Feito no VS
using Fundamentos.Common.Model;
...
//for(int contador=0;contador<listaString.Count;contador++) //Tamanho da Lista = Count.
//{ 
...
//foreach(string coisa in listaString)
//{
//    Console.WriteLine($"Posição N° {contadorForeach} - {coisa}");
//    contadorForeach++;
//}
...
//int[] arrayInteirosDobrado = new int[arrayInteiros.Length * 2]; //Declara um novo array
//Array.Copy(arrayInteiros, arrayInteirosDobrado, arrayInteiros.Length);//Copia os elementos para o novo array e a quantidade de indices a serem copiados.


////Array.Resize(ref arrayInteiros, arrayInteiros.Length * 2); //Vai dobrar a capacidade do Array.

//for(int i=0;i<arrayInteiros.Length;i++)
//{
//    Console.Write($"Posição {i} = {arrayInteiros[i]} | ");
//}
...
//Console.WriteLine("\nArray usando FOREACH com o contador de controle");
//int contadorForeach = 0;
//foreach(int valor in arrayInteiros)
//{
//    Console.WriteLine($"Posição {contadorForeach+1}) {valor}");
//    contadorForeach++;
//}
...
//int [] array = new int[4];
//int[] array1 = new int[] {42,75,74,61};
